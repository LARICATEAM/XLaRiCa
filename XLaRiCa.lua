...
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARICATEAM/XLaRiCa/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/LARICATEAM/XLaRiCa/master/XLaRiCaFiles/"..FileName)
if Res == 200 then
