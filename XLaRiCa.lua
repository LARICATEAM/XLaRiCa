------------------------------------------------
-- This Source Was Developed By (Rio) @sSs_sSs.--
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1573309498,1853749569,1878154430}
...
local inline = {
{{text="⌔ المطور .",url="t.me/"..(dp.username_ or "sSs_sSs")}},
{{text="⌔ السورس .",url="https://t.me/LaRiCaTeam"},{text="⌔ لتنصيب بوت .",url="https://t.me/sSs_sSs"}},{{text="⌔ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌔ Source Channel',url="https://t.me/zzzii"}},{{text = '⌔ Developer',url="t.me/sSs_sSs"},{text = '⌔ Tws XLaRiCa',url="https://t.me/sSs_BoT"}},{{text= '⌔ Exp Source .',url="https://t.me/LaRiCaTeam"}}}
local msg_id = msg.id_/2097152/0.5
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARICATEAM/XLaRiCaFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/LARICATEAM/XLaRiCaFiles/master/XLaRiCaFiles/"..FileName)
if Res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌔ قناة السورس',url="t.me/LaRiCaTeam"}},
}
local msg_id = msg.id_/2097152/0.5
