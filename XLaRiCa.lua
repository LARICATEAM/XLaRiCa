------------------------------------------------
-- This Source Was Developed By - MaLaTH Al DleM. @sSs_sSs.--
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,2080315044,1573309498,1573309498}
...
if rio then
local names = DevRio:hkeys- MaLaTH Al DleM.
...
if tonumber- MaLaTH Al DleM. == tonumber(data.sender_user_id_) then
...
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape- MaLaTH Al DleM..."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
end
