...
send(chat,msg.id_," ⌔︰هذا الملف ليس تابع لسورس لاريكا")
return false 
end      
...
SendText(XLaRiCa,"⌔︰تم تفعيل مجموعه جديده ∵ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰بواسطة ˓ "..Name.."\n⌔︰اسم المجموعه ˓ ["..NameChat.."]\n⌔︰عدد اعضاء المجموعه ˓ ❨ *"..NumMem.."* ❩\n⌔︰ايدي المجموعه ∵ \n❨ `"..data.chat_id_.."` ❩\n⌔︰رابط المجموعه ∵\n❨ ["..LinkGroup.."] ❩\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰الوقت ˓ "..os.date("%I:%M%p").."\n⌔︰التاريخ ˓ "..os.date("%Y/%m/%d").."",0,'md')
end
end
end,nil)
end,nil)
...
DevRio:set(XLaRiCa.."Rio:Groups:Links"..data.chat_id_,LinkGroup) 
if not Sudo(data) then
SendText(XLaRiCa,"⌔︰تم تعطيل مجموعه جديده ∵ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰بواسطة ˓ "..Name.."\n⌔︰اسم المجموعه ˓ ["..NameChat.."]\n⌔︰ايدي المجموعه ∵ \n❨ `"..data.chat_id_.."` ❩\n⌔︰رابط المجموعه ∵\n❨ ["..LinkGroup.."] ❩\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰الوقت ˓ "..os.date("%I:%M%p").."\n⌔︰التاريخ ˓ "..os.date("%Y/%m/%d").."",0,'md')
end
end
end,nil)
end,nil)
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بتحديث  سورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه ب أحصائيات  سورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'˓  الاحصائيات ᯤ'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه ب المطورين لسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه ب التفعيل والتعطيل لسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بالاذاعه لسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'˓ اذاعه بالتثبيت ᯤ'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بالعام لسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بردود الخاص لسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي المطور \n⌔︰اليك الازرار الخاصه بالاشتراك الاجباري لسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'˓ غنيلي ᯤ','˓ اغنيه ᯤ'},
{'˓ ميمز ᯤ','˓ ريمكس ᯤ'},
{'˓ صوره ᯤ','˓ متحركه ᯤ'},
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بأوامر النسب الخاصه بسورس لاريكا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '⌔︰اهلا بك مجددا عزيزي \n⌔︰اليك الازرار الخاصه بألعاب سورس لاريكا فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
SendText(XLaRiCa,'⌔︰تم ارسال الملصق من ∵\n['..string.sub(dp.first_name_,0, 40)..'](tg://user?id='..dp.id_..')',0,'md') 
return false
...
--     Source XLaRiCa     --
if text == "الابراج" or text == "˓ الابراج ᯤ" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰ من خلال البوت يمكنك معرفه توقعات برجك \n⌔︰ فقط قم بارسال امر برج + اسم البرج \n⌔︰ مثال : برج الاسد ،\n⌔︰ لمعرفه برجك قم بالرجوع الى قسم حساب العمر ', 1, 'md') end
if text == "حساب العمر" or text == "˓ حساب العمر ᯤ" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰ من خلال البوت يمكنك حساب عمرك \n⌔︰ فقط قم بارسال امر احسب + مواليدك الى البوت \n⌔︰ بالتنسيق التالي مثال : احسب 2000/7/24', 1, 'md') end
if text == "الحمايه" or text == "˓ الحمايه ᯤ" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰ اضف البوت في المجموعه ثم قم برفعه مشرف وارسل تفعيل \n⌔︰ وتمتع بخدمات غير موجوده في باقي البوتات ', 1, 'md') end
if text == "الزخرفه" or text == "˓ الزخرفه ᯤ" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰قم بأرسال أمر زخرفه وثم ارسال الاسم الذي تريد زخرفته بألانكليزي أو العربي', 1, 'md') end
if text == "اهمس" and ChCheck(msg) or text == "˓ بوت الهمسه ᯤ" and ChCheck(msg) or text == "بوت الهمسه" and ChCheck(msg) or text == "همسه" and ChCheck(msg) or text == "اريد بوت الهمسه" and ChCheck(msg) or text == "دزلي بوت الهمسه" and ChCheck(msg) or text == "دزولي بوت الهمسه" and ChCheck(msg) then  Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰@XllHbot ', 1, 'md') end
...
if text == "معاني الاسماء" or text == "˓ معاني الاسماء ᯤ" then  Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰ من خلال البوت يمكنك معرفه معنى اسمك \n⌔︰ فقط قم بارسال امر معنى اسم + الاسم \n⌔︰ مثال : معنى اسم ريو', 1, 'md') end
...
if text == "ايديي" and ChCheck(msg) or text == "˓ ايديي ᯤ" and ChCheck(msg) then Dev_Rio(msg.chat_id_, msg.id_, 1,'⌔︰ايديك ˓ ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
-- Source XLaRiCa --
...
tdcli_function({ID = "GetUserProfilePhotos",user_id_=XLaRiCa,offset_=0,limit_ = 1},function(arg,getpro) 
...
SendText(XLaRiCa,"⌔︰تم طرد البوت من المجموعه ∵ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰بواسطة ˓ "..Name.."\n⌔︰اسم المجموعه ˓ ["..NameChat.."]\n⌔︰ايدي المجموعه ∵ \n❨ `"..msg.chat_id_.."` ❩\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰الوقت ˓ "..os.date("%I:%M%p").."\n⌔︰التاريخ ˓ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
Text = [[
Welcome To Source
⌔︰[TeAm LaRiCa](https://t.me/LaRiCaTeam)
]]
keyboard = {} 
...
if not Sudo(msg) then
SendText(XLaRiCa,"⌔︰هناك من بحاجه الى مساعده ∵ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰الشخص ˓ "..Name.."\n⌔︰اسم المجموعه ˓ ["..NameChat.."]\n⌔︰ايدي المجموعه ∵ \n❨ `"..msg.chat_id_.."` ❩\n"..LinkGroup.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︰الوقت ˓ "..os.date("%I:%M%p").."\n⌔︰التاريخ ˓ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌔︰جاري تحديث سورس لاريكا', 1, 'md') 
os.execute('rm -rf XLaRiCa.lua') 
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/XLaRiCa/master/XLaRiCa.lua') 
dofile('XLaRiCa.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
Text = [[
⌔︰[قناة السورس](https://t.me/LaRiCaTeam)
]]
keyboard = {} 
keyboard.inline_keyboard = {
